...
?>
<?php if ($userlevels_list->User_Level_ID->Visible) { // User_Level_ID ?>
	<?php if ($userlevels_list->SortUrl($userlevels_list->User_Level_ID) == "") { ?>
		<th data-name="User_Level_ID" class="<?php echo $userlevels_list->User_Level_ID->headerCellClass() ?>"><div id="elh_userlevels_User_Level_ID" class="userlevels_User_Level_ID"><div class="ew-table-header-caption"><?php echo $userlevels_list->User_Level_ID->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="User_Level_ID" class="<?php echo $userlevels_list->User_Level_ID->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $userlevels_list->SortUrl($userlevels_list->User_Level_ID) ?>', 1);"><div id="elh_userlevels_User_Level_ID" class="userlevels_User_Level_ID">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $userlevels_list->User_Level_ID->caption() ?></span><span class="ew-table-header-sort"><?php if ($userlevels_list->User_Level_ID->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($userlevels_list->User_Level_ID->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($userlevels_list->User_Level_Name->Visible) { // User_Level_Name ?>
	<?php if ($userlevels_list->SortUrl($userlevels_list->User_Level_Name) == "") { ?>
		<th data-name="User_Level_Name" class="<?php echo $userlevels_list->User_Level_Name->headerCellClass() ?>"><div id="elh_userlevels_User_Level_Name" class="userlevels_User_Level_Name"><div class="ew-table-header-caption"><?php echo $userlevels_list->User_Level_Name->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="User_Level_Name" class="<?php echo $userlevels_list->User_Level_Name->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $userlevels_list->SortUrl($userlevels_list->User_Level_Name) ?>', 1);"><div id="elh_userlevels_User_Level_Name" class="userlevels_User_Level_Name">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $userlevels_list->User_Level_Name->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($userlevels_list->User_Level_Name->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($userlevels_list->User_Level_Name->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
?>
	<?php if ($userlevels_list->User_Level_ID->Visible) { // User_Level_ID ?>
		<td data-name="User_Level_ID" <?php echo $userlevels_list->User_Level_ID->cellAttributes() ?>>
<span id="el<?php echo $userlevels_list->RowCount ?>_userlevels_User_Level_ID">
<span<?php echo $userlevels_list->User_Level_ID->viewAttributes() ?>><?php echo $userlevels_list->User_Level_ID->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($userlevels_list->User_Level_Name->Visible) { // User_Level_Name ?>
		<td data-name="User_Level_Name" <?php echo $userlevels_list->User_Level_Name->cellAttributes() ?>>
<span id="el<?php echo $userlevels_list->RowCount ?>_userlevels_User_Level_Name">
<span<?php echo $userlevels_list->User_Level_Name->viewAttributes() ?>><?php echo $userlevels_list->User_Level_Name->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
